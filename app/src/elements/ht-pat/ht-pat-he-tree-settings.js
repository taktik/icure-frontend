...
class HtPatHeTreeSettings extends TkLocalizerMixin(PolymerElement) {
  static get template() {
    return html`
        ...
        <div class="tooltips">
            <paper-tooltip position="bottom" for="settings-btn-show">[[localize('settings','Settings',language)]]</paper-tooltip>
            <paper-tooltip position="bottom" for="settings-btn-by-time">[[localize('by_dat','By date',language)]]</paper-tooltip>
            <paper-tooltip position="bottom" for="settings-btn-by-code">[[localize('by_code','By Code',language)]]</paper-tooltip>
            <paper-tooltip position="bottom" for="he-edit-btn-archived">[[localize('show_irr','ebmPracticeNet',language)]]</paper-tooltip>
        </div>
`;
  }
  ...
  _sortByTime(e) {
      ...
      this.dispatchEvent(new CustomEvent('settings-changed',{detail: {section: this.section, type: 'sort', value: 'created'}, bubbles:true, composed:true}))
  }
  ...
  _sortByCode(e) {
      ...
      this.dispatchEvent(new CustomEvent('settings-changed',{detail: {section: this.section, type: 'sort', value: 'icpc'}, bubbles:true, composed:true}))
  }
  ...
  _toggleInactive(e) {
      ...
      this.dispatchEvent(new CustomEvent('settings-changed',{detail: {section: this.section, type: 'showInactive', value: localStorage.getItem(sectionShowInactive) === 'true'}, bubbles:true, composed:true}))
  }
}
