...
$_documentContainer.innerHTML = `<custom-style>
	<style is="custom-style">
		...
		--app-secondary-color:#FF5000;
		--app-secondary-color-light: #FF7300;
		--app-secondary-color-dark: #DD3415;
		--app-secondary-color-highlight:#FFCB00;
		--app-accent-color: #17EFDD;
		--app-accent-color-light: #70FFFF;
		--app-accent-color-dark: #00BCAB;
