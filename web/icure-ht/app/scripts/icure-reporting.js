...
function peg$parse(input, options) {
	...
	var peg$FAILED = {},
		...
		peg$c21 = function(head, tail) { return tail.length && {'$type':'UnionFilter', 'filters':[head].concat(tail.map(it=>it[3]))} || head },
		peg$c22 = "&",
		peg$c23 = peg$literalExpectation("&", false),
		peg$c24 = function(head, tail) { return tail.length && {'$type':'IntersectionFilter', 'filters':[head].concat(tail.map(it=>it[3]))} || head },
