...
`;
  ...
  _saveDocumentAsService(inputConfig) {
      ...
      return promResolve
          ...
          .then(()=> !_.get(inputConfig,"forceNoRefreshPatientFile",false) ? this.dispatchEvent(new CustomEvent('refresh-patient', {composed: true, bubbles: true, detail: {}})) : null )
      ...
      if(!!_.trim(_.get(this,"_data.currentMh.id"))) {
          staticVariables.push({
              ...
              subVars: [
                  ...
                  {name: this.localize('phone', 'Phone', this.language), nodes: [{type: 'variable', attrs: {expr: 'mh.phone'}},{type:'text', text: ' '}]},
              ]
          })
      }
  ...
  _saveMedexIttToPatFile() {
      ...
      return this.api.message().newInstanceWithPatient(_.get(this,"user",{}), _.get(this,"_data.currentPatient",{}))
          ...
          .catch(e => { console.log("[ERROR] _saveMedexIttToPatFile", e); return Promise.resolve(); })
  ...
  printMedexPdfItt(dataFromPatDetail) {
      ...
      return this._resetComponentProperties()
          ...
          .then(([createdMessage,createdDocument]) => _.merge(this._data.pdf, {createdMessage:createdMessage,createdDocument:createdDocument}))
          .then(() => this._data)
          .catch(e => console.log("[ERROR] printMedexPdfItt", e, dataFromPatDetail,this._data))
          .finally(() => { console.log("[Outgoing document, printMedexPdfItt, _data]",this._data); this.set("_isBusy", false); return this._data; })
  }
