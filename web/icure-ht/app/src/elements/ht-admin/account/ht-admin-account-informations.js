...
class HtAdminAccountInformations extends Polymer.TkLocalizerMixin(Polymer.Element) {
  static get template() {
    return Polymer.html`
        ...
        <div class="user-info-panel">
            <h4 class="section-title">[[localize('my_pro', 'My profil', language)]] - [[localize('acc_info', 'Informations', language)]]</h4>

                <div class="tile">
                    <h4 class="title"><iron-icon icon="communication:vpn-key"></iron-icon> [[localize('login_opt','Login option',language)]]</h4>
                    <div class="body">
                ...
                <div class="tile">
                    <h4 class="title"><iron-icon icon="settings"></iron-icon> [[localize('oth_opt','Other options',language)]]</h4>
                    <div class="body">
                ...
                <div class="tile">
                    <h4 class="title"><iron-icon icon="social:person"></iron-icon> [[localize('gen_info','General informations',language)]]</h4>
                    <div class="body">
                        <template is="dom-if" if="[[!_isMedicalHouse(hcp.type)]]">
                            <div class="line">
                ...
                <div class="tile">
                    <h4 class="title"><iron-icon icon="home"></iron-icon> [[localize('addr_pro','Work Address',language)]]</h4>
                    <div class="body">
                        <div class="line">
                ...
                <template is="dom-if" if="[[!_isMedicalHouse(hcp.type)]]">
                    <div class="tile">
                        <h4 class="title"><iron-icon icon="assignment"></iron-icon> [[localize('info','Informations',language)]] [[localize('inv_prest','physician',language)]]</h4>
                        <div class="body">
