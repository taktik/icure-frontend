...
class HtAdminAccountPreferences extends Polymer.TkLocalizerMixin(Polymer.Element) {
  static get template() {
    return Polymer.html`
        ...
        <div class="users-panel">
            ...
            <div class="card ehbox">
                ...
                <div class="content">
                    ...
                    <paper-checkbox checked="{{assignMailAuto}}">[[localize('','Assign mails automatically',language)]]</paper-checkbox>
                </div>
            </div>
